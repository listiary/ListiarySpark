<?php
	...
	//FF metadata stands for File to Files
	//it describes what other files each file is related to
	function MetadataFF_Fetch($fileName, $configRelativePath = "/_configs/config.php") {
